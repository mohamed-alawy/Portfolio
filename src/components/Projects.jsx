                        ...
                        >
                            ...
                            <div className="project-links">
                                {project.links.github ? (
                                    <a href={project.links.github} className="link-btn" aria-label="GitHub Code" target="_blank" rel="noopener noreferrer">
                                        <Github size={18} /> Code
                                    </a>
                                ) : (
                                ...
                                {project.links.demo && (
                                    <a href={project.links.demo} className="link-btn outline" aria-label={project.demoLabel || "Live Demo"} target="_blank" rel="noopener noreferrer">
